...
describe 'ESR payment' do
  describe ESRPayment, 'segment 1' do
    ...
    it 'should have a reference number' do
      Factory.create_esr_payment(:reference_number => 'ABC0100123478901').segment1[53,16].should == 'ABC0100123478901'
    end
    
    it 'should have a debit account without IBAN justified left filled with blanks' do
      Factory.create_esr_payment(:debit_account_number => '10235678').segment1[69,24].should == '10235678                '
    end
    
    it 'should have a debit account with IBAN' do
      Factory.create_esr_payment(:debit_account_number => 'CH9300762011623852957').segment1[69,24].should == 'CH9300762011623852957   '
    end
    ...
    it 'should have a debit amount currency code' do
     Factory.create_esr_payment(:debit_amount_currency => 'CHF').segment1[99,3].should == 'CHF'
    end
    
    it 'should have a debit amount justified left filled with blanks' do
      Factory.create_esr_payment(:debit_amount => '3949.75').segment1[102,12].should == '3949.75     '
    end
    ...
    describe 'header' do
      it 'should have a total length of 51 characters' do
        Factory.create_esr_payment.header.size.should == 51
      end

      it 'should set a the correct execution date' do
        Factory.create_esr_payment(:execution_date => '051021').header[0,6].should == '051021'
      end
      ...
      it 'should fill out a blank sequence number' do
        Factory.create_esr_payment.header[18,5].should == '00000'
      end

      it 'should set the creation date' do
        Factory.create_esr_payment.header[23,6].should == Date.today.strftime('%y%m%d')
      end

      it 'should set the payers clearing number and pad it' do
        Factory.create_esr_payment(:payers_clearing_number => '254').header[29,7].should == '2540000'
      end

      it 'should set the file identification' do
        Factory.create_esr_payment(:file_identification => 'ABC12').header[36,5].should == 'ABC12'
      end

      it 'should should set the record sequence number' do
       Factory.create_esr_payment(:record_sequence_number => 1).header[41,5].should == '00001'
      end
      ...
      it 'should set the payment type to 1' do
       Factory.create_esr_payment.header[49,1].should == '1' 
      end

      it 'should set the transaction flag to 0' do
       Factory.create_esr_payment.header[50,1].should == '0' 
      end
    end
  ...
  describe ESRPayment, 'segment 2' do
    ...
    it 'should have an issuer address line 1' do
      Factory.create_esr_payment(:issuer_address_line1 => 'John Doe').segment2[2,20].should == 'John Doe'.ljust(20)
    end

    it 'should have an issuer address line 2' do
      Factory.create_esr_payment(:issuer_address_line2 => 'Bahnhofstrasse 1').segment2[22,20].should == 'Bahnhofstrasse 1'.ljust(20)      
    end

    it 'should have an issuer address line 3' do
      Factory.create_esr_payment(:issuer_address_line3 => '8000 Zurich').segment2[42,20].should == '8000 Zurich'.ljust(20)
    end
    
    it 'should have an issuer address line 4' do
      Factory.create_esr_payment(:issuer_address_line4 => 'Schweiz').segment2[62,20].should == 'Schweiz'.ljust(20)
    end
  ...
  describe ESRPayment, 'segment 3' do
    ...
    it 'should have the recipients ESR number' do
      Factory.create_esr_payment(:recipient_esr_number => '012127029').segment3[2,12].should == '/C/012127029'
    end
    ...
    describe 'ESR reference number with 9 figure recipient esr number' do
      it 'should have an ESR reference number' do
        Factory.create_esr_payment(:recipient_esr_number => '012127029',:esr_reference_number => '123456789012345678901234567').segment3[94,27].should == '123456789012345678901234567'
      end
    
      it 'should justify right the ESR reference number' do
        Factory.create_esr_payment(:recipient_esr_number => '12127029',:esr_reference_number => '9876543210123456').segment3[94,27].should == '000000000009876543210123456'
      end
      
      it 'should have an esr reference number check' do
        Factory.create_esr_payment(:recipient_esr_number => '12127029').segment3[121,2].should == '  '
      end
    end
    ...
    describe 'ESR reference number with 5 figure recipient esr number' do
      it 'should have an ESR reference number justified left with blanks' do
        Factory.create_esr_payment(:recipient_esr_number => '10304', :esr_reference_number => '012345678901234').segment3[94,27].should == '012345678901234'.ljust(27)
      end
      
      it 'should have an esr reference number check' do
        Factory.create_esr_payment(:recipient_esr_number => '10304', :recipient_esr_number_check => '45').segment3[121,2].should == '45'
      end
    end
